...
app.post('/users/signin', async (req, res) => {
  ...
  const loadedUser = await res.locals.store.authenticateUser(username, password);
  if (loadedUser){
...
app.get("/lists", requiresAuthentication ,async (req, res) => {
  try {
...
app.get("/lists/:todoListId", requiresAuthentication, async (req, res, next) => {
...
app.post("/lists/:todoListId/todos/:todoId/toggle", requiresAuthentication, async (req, res, next) => {
  try {
...
// Delete a todo
app.post("/lists/:todoListId/todos/:todoId/destroy", requiresAuthentication, async (req, res, next) => {
  try {
    let { todoListId, todoId } = req.params;
...
app.post("/lists/:todoListId/complete_all", requiresAuthentication, async (req, res, next) => {
  try {
    let todoListId = req.params.todoListId;
...
// Delete todo list
app.post("/lists/:todoListId/destroy", requiresAuthentication, async (req, res, next) => {
  let todoListId = +req.params.todoListId;
